...
class HotelController extends AbstractController
{
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $uploadfile = $this->getParameter('images_directory') ."/". basename($request->files->get("hotel1")['name']["image"]);
            
            if (move_uploaded_file($request->files->get("hotel1")['tmp_name']["image"], $uploadfile)) {
                $hotel->setImage($request->files->get("hotel1")['name']["image"]);
