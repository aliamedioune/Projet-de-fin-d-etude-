    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
           ...
           //************** file upload ***>>>>>>>>>>>>
            ...
            $uploadfile = $this->getParameter('images_directory') ."/". basename($request->files->get("hotel")['name']["image"]);
            
            if (move_uploaded_file($request->files->get("hotel")['tmp_name']["image"], $uploadfile)) {
                $hotel->setImage($request->files->get("hotel")['name']["image"]);
