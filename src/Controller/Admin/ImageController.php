    ...
    public function new(Request $request,$id,ImageRepository $imageRepository): Response
    {
       ...
       // die();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $uploadfile = $this->getParameter('images_directory') ."/". basename($request->files->get("image")['name']["image"]);
            
            if (move_uploaded_file($request->files->get("image")['tmp_name']["image"], $uploadfile)) {
                $image->setImage($request->files->get("image")['name']["image"]);
